    ...
    return (
        ...
        >
          <View style={{height:'50%',width:'90%', backgroundColor:'white',alignSelf:'center', marginTop:180}}>
             ...
             <ImageBackground source={require('../assets/kol.jpg')} style={{width: '100%', height: '100%'}}>
            ...
            <View style={{flex: 1.3}}>
                ...
                <View style={{flex:0.2, flexDirection: 'row', alignSelf:'flex-end', justifyContent:'flex-end',}}>
                    <TouchableOpacity
                        onPress={() => {
