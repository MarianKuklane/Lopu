...
import {
    ...
    Image,
    ScrollView,
    Picker,Alert,TextInput, ImageBackground,Modal, TouchableHighlight
} from 'react-native';
        ...
        >
          <View style={{height:'50%',width:'90%', backgroundColor:'white',alignSelf:'center', marginTop:180}}>
              <TouchableHighlight
                ...
                <Text style={{alignSelf:'flex-end', marginRight:15,marginTop:5, fontSize:14}}>X</Text>
              </TouchableHighlight>
             ...
             <ImageBackground source={require('../assets/kasi.jpg')} style={{width: '100%', height: '100%', resizeMode:'contain'}}>
            ...
            <View style={{flex: 1.3}}>
                ...
                <View style={{flex:2, flexDirection: 'row', alignSelf:'flex-end', justifyContent:'flex-end',}}>
                    <TouchableOpacity
                        ...
                        <Image source={require('../assets/mati.png')} style={{height:35,width:35, top: 0,  position:'absolute',right:90, bottom:20}}></Image>
