        ...
        >
          <View style={{height:'50%',width:'90%', backgroundColor:'gray',alignSelf:'center', marginTop:180}}>
              <TouchableHighlight
                ...
                <Text style={{alignSelf:'flex-end',color:'white', marginRight:15,marginTop:5, fontSize:18}}>X</Text>
              </TouchableHighlight>
             ...
             <ImageBackground source={require('../assets/laige.jpg')} style={{width: '100%', height: '100%', resizeMode:'contain'}}>
